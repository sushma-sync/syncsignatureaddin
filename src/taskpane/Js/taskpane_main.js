...
function set_dummy_data()
{
  ...
  save_signature_settings();
	fetchSignatureFromSyncSignatureold();
...
// Initialize the PCA (Public Client Application) for MSAL
...
// Create headers with the acquired token
...
// Modified fetchSignatureFromSyncSignature to use the new token acquisition
...
// Modified insertDefaultSignature function to use the new token acquisition
function insertDefaultSignature(event) {
